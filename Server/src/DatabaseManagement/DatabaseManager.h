...
using DatabaseManagement_Types::DataPoolSize;
using DatabaseManagement_Types::DataPoolPath;
using DatabaseManagement_Types::DataPoolRetention;
...
namespace SyncServer_Core
{
    ...
    class DatabaseManager::Functions_Users
    {
        ...
        public:
            ...
            bool userPasswordMatch(UserID user, string password);
            bool userPasswordMatch(string username, string password);
    };
